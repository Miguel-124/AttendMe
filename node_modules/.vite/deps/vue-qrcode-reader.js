...
var dt = (() => {
  ...
  return function(o = {}) {
    ...
    var U, W = false, R, A, X, k, D, M, le, ie;
    function be() {
      var e = U.buffer;
...
`,
    ...
    function yr() {
      if (te > 0 || (Le(), te > 0))
        return;
      function e() {
        rt || (rt = true, i.calledRun = true, !W && (ft(), c(i), i.onRuntimeInitialized && i.onRuntimeInitialized(), ht()));
      }
...
var je;
var ut = class extends EventTarget {
  constructor(o = {}) {
    var i;
...
var zr = async (r, o = ["qr_code"]) => await new ut({ formats: o }).detect(r);
    ...
    watch(
      ...
      async (k) => {
        ...
        if (ae(le !== null, "if cavnas is defined, canvas 2d context should also be non-null"), k.shouldStream) {
          ...
          M.width = D.videoWidth, M.height = D.videoHeight, le.drawImage(D, 0, 0, D.videoWidth, D.videoHeight), it(), p.value = false, c("camera-off");
      },
      { deep: true }
    ), watch(h, async (k) => {
      C.value && await Nr(k);
